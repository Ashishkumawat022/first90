                  ...
                  <Card.Body>
                    <Row className={`${lx.ActionFormBox}`}>
                      <Col className={`${lx.LeftBox}`}>
                        <Form.Label>Action: Upload a File</Form.Label>
                      </Col>
                    ...
                    <Form className="row">
                      ...
                      >
                        <Form.Control type="text" placeholder="File Name" defaultValue={`${props.value.content.title == "" ? "" : props.value.content.title}`}
                          onChange={(event) => {
