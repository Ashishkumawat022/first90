                    ...
                    <Card.Body>
                      <Row className={`${lx.ActionFormBox}`}>
                        <Col className={`${lx.LeftBox}`}>
                          <Form.Label>Action: Read an Email</Form.Label>
                        </Col>
                      ...
                      <Form className="row">
                        ...
                        <Form.Group
                          ...
                          controlId="exampleForm.ControlInput1"
                        >
                          <Form.Label>Sender Headshot</Form.Label>
                          <Row className="align-items-center">
                            ...
                            <Col lg={8}>
                              <Form.Control
                                type="text"
                                placeholder="From: (Email Sender)"
                                defaultValue={`${
                                  props.value.content.from == ""
                                    ? ""
                                    : props.value.content.from
                                }`}
                                onChange={(event) => {
                                  props.value.content.from = event.target.value;
                                }}
                              />
                            </Col>
                          </Row>
                        ...
                        >
                          <Form.Control
                            ...
                            defaultValue={`${
                              props.value.content.subject == ""
                                ? ""
                                : props.value.content.subject
                            }`}
                            onChange={(event) => {
                              props.value.content.subject = event.target.value;
                            }}
                          />
                        </Form.Group>
                        <Form.Group
                        ...
                        >
                          <Form.Control
                            ...
                            defaultValue={`${
                              props.value.content.text == ""
                                ? ""
                                : props.value.content.text
                            }`}
                            onChange={(event) => {
                              props.value.content.text = event.target.value;
                            }}
                          />
                        </Form.Group>
                        <Form.Group
                        ...
                        >
                          <Form.Label>Email Attachment</Form.Label>
