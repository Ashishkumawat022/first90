...
import lx from "./Step6.module.scss";
...
const Step6 = (props: any) => {
  ...
  const statusChangerResponse = (responseData: any) => {
    ...
    history.push(`/participant/dashboard/${simulationId}`);
  };
                    ...
                    <Row>
                      ...
                      >
                        ...
                        <div className={`${lx.fileUpload}`}>
                          <img
                            src="../images/participant_img.svg"
                      ...
                      <Col className={`text-end ${cx.submitActionBox}`}>
                        <button className={`btn ${cx.submitBtnBorder}`}>
                          Submit for Feedback
                        </button>
                      </Col>
                    </Row>
              ...
              <Card.Body>
                <Form className="row">
                  ...
                  >
                    ...
                    <p>
                      Read the following email from Mark (the lead partner on
                      the transaction), which summarizes the results of the due
                      diligence and summarizes next steps.
                    </p>
                  </Form.Group>
                      ...
                      <Col lg={12}>
                        <div className={`${lx.emailMessage}`}>
                          ...
                          <p>
                            ...
                            these high-risk areas in the final APS:
                          </p>

                          <p>
                            - Pending litigitation regarding executive
                            compensation contracts
                          </p>
                          <p>
                            - NYT News article on the client’s Sri Lanka call
                            center operations and potential human rights
                            violations
                          </p>
                          <p>
                            - Third party contract with Avatar Inc. that can’t
                            be assigned to our client in event of sale (meaning
                            we need to consider termination clauses)
                          </p>

                          <p>
                            Can you email me the top potential APS examples we
                            can use as templates and their pros and cons? I want
                            to make sure we find the right one to save ourselves
                            work down the line.
                          </p>
              ...
              <Card.Body>
                <Form className="row">
                  ...
                  >
                    ...
                    <p className={`mb-0 mt-3 ${lx.achearLink}`}>
                      <NavLink to="#">
                        Precedent APS Contracts - Unlimited Bank{" "}
              ...
              <Card.Body>
                <Form className="row">
                  ...
                  >
                    ...
                    <p>
                      Write an email to Mark here, outlining your top precedent
                      APS documents and the pros and cons of each.
                    </p>
                  </Form.Group>
              ...
              <Card.Body>
                <Form className="row">
                  ...
                  >
                    ...
                    <p>
                      Please see below for a video welcoming you to the firm and
                      introducing you to your first client: Unlimited Bank.
                    </p>
                ...
                <Form className="row">
                  ...
                  >
                    ...
                    <div className={`${lx.link}`}>
                      <NavLink to="#">https://www.hotshotlegal.com</NavLink>{" "}
                      <FiLink className={`${lx.icon}`} />
                    </div>
                  </Form.Group>
                </Form>
              </Card.Body>
              ...
              <Card.Body>
                <Form className="row">
                  ...
                  >
                    ...
                    <p>
                      Please see below for Rocketeer Loan’s organizational
                      chart. You may consider this to be relevant information as
                      you complete the APS.
                    </p>

                    <img
                      src="../images/aa.jpg"
                      className={`${lx.uploadedimg}`}
                    />
                  </Form.Group>
                </Form>
              </Card.Body>
            ...
            <Card className={`${lx.disabled}`}>
              <Card.Body>
                <Form className="row">
                  ...
                  >
                    <Form.Label style={{ fontSize: "15px" }}>
                      1. What questions are you hoping to ask the client in your
                      conversation?
                    </Form.Label>
                    <Form.Control type="text" placeholder="" />
                  </Form.Group>
                  ...
                  >
                    <Form.Label style={{ fontSize: "15px" }}>
                      2. What questions do you expect they will have for you?
                    </Form.Label>
                    <Form.Control type="text" placeholder="" />
                  </Form.Group>
            ...
            <Card className={`${lx.disabled}`}>
              <Card.Body>
                <Form className="row">
                  ...
                  >
                    <Form.Label>
                      Schedule a discussion with Nadia Bhassi - AtB Senior
                      Associate
                    </Form.Label>
                    <p>
                      Nadia is a Senior Associate at AtB in the Corporate M&A
                      practice. She has been at the firm for 5 years and has
                      represented Unlimited Bank previously.
                    </p>
                    <p>
                      Please email Nadia and cc her assistant Gail Spencer
                      (gail@abovethebar.com) to set up a meeting in the next 24
                      hours. Be sure to include your revised APS and what you
                      hope to discuss in the meeting. Click the “Submit for
                      Feedback” Button once you have scheduled the meeting.{" "}
                    </p>
                  </Form.Group>
                  <div className={`${lx.actionDetails}`}>
                    ...
                    <div className={`${lx.actionDetailsBody}`}>
                      <p>
                        <b>Action Title:</b> Carina Feng
                      </p>
                      <p>
                        <b>Email:</b> carina.feng@abovethebar.com
                      </p>
                      <p>
                        <b>Phone:</b> 1-820-0204-5729
                      </p>
                    </div>
                  </div>
                  <Col className={`text-end ${cx.submitActionBox}`}>
          ...
          <Row className="align-items-center">
            <Col md={8}>
              <div className={`${lx.contentBox}`}>
                ...
                <p>
                  We’re excited to help you hit the ground running. Good luck!
                </p>
                <div className={`${lx.btnGroups}`}>
                  <NavLink
                    className={`btn ${lx.darkBtn}`}
                    to="#"
                    onClick={() => {
                      statusChanger();
                    }}
                  ...
                  <NavLink
                    className={`btn ${lx.borderBtn}`}
                    to="/participant/step2"
                  >
                    Repeat tour
                  </NavLink>
                </div>
