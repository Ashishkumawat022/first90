...
import lx from './Step3.module.scss';
            ...
            <div className={`${lx.indinxing} ${lx.disabled}`}>
              <div className={`${lx.sideCard}`}>
                ...
                <div className={`${lx.indixingContent}`}>
                  <p>Here you’ll find some helpful advice from colleagues who have been in your shoes!</p>
                  <div className={`${lx.btns}`}>
                    <NavLink className={`${lx.atBtn} btn`} to="/participant/step2"><AiOutlineArrowLeft className='me-2' /> Previous</NavLink>
                    <NavLink className={`${lx.atBtn} btn`} to="/participant/step4">Next <AiOutlineArrowRight className='ms-2' /></NavLink>
                  </div>
                </div>
              </div></div>
          </Col>
