...
import lx from './Step5.module.scss';
    ...
    <>
      ...
      <div className={`${lx.indinxing} ${lx.disabled}`}>
        ...
        <div className={`${lx.indixingContent}`}>
          <p>Click the resources icon to access your unlocked resources from all previous steps.</p>
          <div className={`${lx.btns}`}>
            <NavLink className={`${lx.atBtn} btn`} to="/participant/step4"><AiOutlineArrowLeft className='me-2' /> Previous</NavLink>
            <NavLink className={`${lx.atBtn} btn`} to="/participant/step6">Done <AiOutlineArrowRight className='ms-2' /></NavLink>
          </div>
        </div>
      </div>
