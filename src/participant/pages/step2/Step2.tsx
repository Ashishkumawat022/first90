...
import lx from './Step2.module.scss';
      ...
      <section className={`${cx.pageWrapper}`}>
        ...
        <Row>
          ...
          <Col lg={3}>
            ...
            <div className={`${lx.indinxing} ${lx.disabled}`}>
              <div className={`${lx.sideCard}`}>
                ...
                <div className={`${lx.indixingContent}`}>
                  <p>These resources are here to help you throughout the simulation - use them if you need!</p>
                  <div className={`${lx.btns}`}>
                    <NavLink className={`${lx.atBtn} btn`} to="/participant/step1"><AiOutlineArrowLeft className='me-2' /> Previous</NavLink>
                    <NavLink className={`${lx.atBtn} btn`} to="/participant/step3">Next <AiOutlineArrowRight className='ms-2' /></NavLink>
                  </div>
                </div>
